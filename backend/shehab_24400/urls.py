"""shehab_24400 URL Configuration
...
admin.site.site_header = "shehab"
admin.site.site_title = "shehab Admin Portal"
admin.site.index_title = "shehab Admin"

# swagger
api_info = openapi.Info(
    title="shehab API",
    default_version="v1",
    description="API documentation for shehab App",
)
